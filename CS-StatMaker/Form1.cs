...
namespace CS_StatMaker
{
    public partial class Form1 : Form
    {
        ...
        private void RaceDropbox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Program.SelectRace(RaceDropbox, StrBonus, DexBonus, ConBonus, IntBonus, WisBonus, ChaBonus, SkillProficencyListbox, ToolProficencyListbox, WeaponProficencyListbox, ArmorProficencyListbox);
